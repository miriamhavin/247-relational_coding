...
comp_sig_elecs = [elec.replace('EEG', '').replace('GR_', 'G').replace('_', '').replace('REF','') for elec in comp_sig_elecs]
prod_sig_elecs = pd.read_csv(prod_sig_file)['electrode'].tolist()
prod_sig_elecs = [elec.replace('EEG', '').replace('GR_', 'G').replace('_', '').replace('REF','') for elec in prod_sig_elecs]
